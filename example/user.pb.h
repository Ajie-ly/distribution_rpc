...
extern RegisterReponseDefaultTypeInternal _RegisterReponse_default_instance_;
...
template<> ::fixbug::RegisterReponse* Arena::CreateMaybeMessage<::fixbug::RegisterReponse>(Arena*);
...
class RegisterReponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegisterReponse) */ {
 public:
  inline RegisterReponse() : RegisterReponse(nullptr) {}
  ~RegisterReponse() override;
  explicit PROTOBUF_CONSTEXPR RegisterReponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RegisterReponse(const RegisterReponse& from);
  RegisterReponse(RegisterReponse&& from) noexcept
    : RegisterReponse() {
    *this = ::std::move(from);
  }

  inline RegisterReponse& operator=(const RegisterReponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegisterReponse& operator=(RegisterReponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const RegisterReponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const RegisterReponse* internal_default_instance() {
    return reinterpret_cast<const RegisterReponse*>(
               &_RegisterReponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(RegisterReponse& a, RegisterReponse& b) {
    a.Swap(&b);
  }
  inline void Swap(RegisterReponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(RegisterReponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  RegisterReponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RegisterReponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const RegisterReponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const RegisterReponse& from) {
    RegisterReponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegisterReponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegisterReponse";
  }
  protected:
  explicit RegisterReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegisterReponse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool RegisterReponse::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool RegisterReponse::has_result() const {
  return _internal_has_result();
}
inline void RegisterReponse::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& RegisterReponse::_internal_result() const {
  const ::fixbug::ResultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& RegisterReponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterReponse.result)
  return _internal_result();
}
inline void RegisterReponse::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterReponse.result)
}
inline ::fixbug::ResultCode* RegisterReponse::release_result() {
...
inline ::fixbug::ResultCode* RegisterReponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterReponse.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* RegisterReponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* RegisterReponse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterReponse.result)
  return _msg;
}
inline void RegisterReponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterReponse.result)
}

// bool success = 2;
inline void RegisterReponse::clear_success() {
  _impl_.success_ = false;
}
inline bool RegisterReponse::_internal_success() const {
  return _impl_.success_;
}
inline bool RegisterReponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterReponse.success)
  return _internal_success();
}
inline void RegisterReponse::_internal_set_success(bool value) {
  
  _impl_.success_ = value;
}
inline void RegisterReponse::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterReponse.success)
}
