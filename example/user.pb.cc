...
PROTOBUF_CONSTEXPR RegisterReponse::RegisterReponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.result_)*/nullptr
  , /*decltype(_impl_.success_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct RegisterReponseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RegisterReponseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RegisterReponseDefaultTypeInternal() {}
  union {
    RegisterReponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RegisterReponseDefaultTypeInternal _RegisterReponse_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReponse, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterReponse, _impl_.success_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 33, -1, -1, sizeof(::fixbug::RegisterReponse)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::fixbug::_RegisterReponse_default_instance_._instance,
};
...
class RegisterReponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const RegisterReponse* msg);
};

const ::fixbug::ResultCode&
RegisterReponse::_Internal::result(const RegisterReponse* msg) {
  return *msg->_impl_.result_;
}
RegisterReponse::RegisterReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.RegisterReponse)
}
RegisterReponse::RegisterReponse(const RegisterReponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RegisterReponse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.result_){nullptr}
    , decltype(_impl_.success_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _this->_impl_.success_ = from._impl_.success_;
  // @@protoc_insertion_point(copy_constructor:fixbug.RegisterReponse)
}

inline void RegisterReponse::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
RegisterReponse::~RegisterReponse() {
  // @@protoc_insertion_point(destructor:fixbug.RegisterReponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void RegisterReponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.result_;
}

void RegisterReponse::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void RegisterReponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.RegisterReponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* RegisterReponse::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* RegisterReponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.RegisterReponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.RegisterReponse)
  return target;
}

size_t RegisterReponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.RegisterReponse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RegisterReponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RegisterReponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RegisterReponse::GetClassData() const { return &_class_data_; }


void RegisterReponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RegisterReponse*>(&to_msg);
  auto& from = static_cast<const RegisterReponse&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.RegisterReponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void RegisterReponse::CopyFrom(const RegisterReponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.RegisterReponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RegisterReponse::IsInitialized() const {
  return true;
}

void RegisterReponse::InternalSwap(RegisterReponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RegisterReponse, _impl_.success_)
      + sizeof(RegisterReponse::_impl_.success_)
      - PROTOBUF_FIELD_OFFSET(RegisterReponse, _impl_.result_)>(
          reinterpret_cast<char*>(&_impl_.result_),
          reinterpret_cast<char*>(&other->_impl_.result_));
}

::PROTOBUF_NAMESPACE_ID::Metadata RegisterReponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_user_2eproto_getter, &descriptor_table_user_2eproto_once,
    ...
    case 1:
      Register(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::RegisterRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::RegisterReponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::RegisterReponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::RegisterReponse*
Arena::CreateMaybeMessage< ::fixbug::RegisterReponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::RegisterReponse >(arena);
}
